...
const char* ssid = "ELMALEK";  //WiFi Name
const char* password = "Mahmoud01220082349&";  //WiFi Password

// Use @myidbot to find out the chat ID of an individual or a group
// You need to click "start" on a bot before it can message you 
// Initialize Telegram BOT
String chatId = "1180728139";
String BOTtoken = "6576962154:AAF5E9TFaAfAxE0ry3BkIyPLHfmNbx1H4rg";
